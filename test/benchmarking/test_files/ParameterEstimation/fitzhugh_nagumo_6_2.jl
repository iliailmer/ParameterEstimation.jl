...
p_constraints = Dict((g=>(0.0, 2.0)), (a=>(0.0, 2.0)), (b=>(0.0, 2.0)))
ic_constraints = Dict((V=>(0.0, 2.0)), (R=>(0.0, 2.0)))
 
time_interval = [-0.5, 0.5]
datasize = 21

data_sample = load("../data/julia/fitzhugh_nagumo_6.jld2", "data")
