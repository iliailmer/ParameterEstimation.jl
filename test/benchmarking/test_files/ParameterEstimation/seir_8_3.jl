...
p_constraints = Dict((a=>(0.0, 3.0)), (b=>(0.0, 3.0)), (nu=>(0.0, 3.0)))
ic_constraints = Dict((S=>(0.0, 3.0)), (E=>(0.0, 3.0)), (In=>(0.0, 3.0)), (NN=>(0.0, 3.0)))
 
time_interval = [-0.5, 0.5]
datasize = 21

data_sample = load("../data/julia/seir_8.jld2", "data")
