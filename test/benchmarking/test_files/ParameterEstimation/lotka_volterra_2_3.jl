...
p_constraints = Dict((k1=>(0.0, 3.0)), (k2=>(0.0, 3.0)), (k3=>(0.0, 3.0)))
ic_constraints = Dict((r=>(0.0, 3.0)), (w=>(0.0, 3.0)))
 
time_interval = [-0.5, 0.5]
datasize = 21

data_sample = load("../data/julia/lotka_volterra_2.jld2", "data")
