...
p_constraints = Dict((k01=>(0.0, 3.0)), (k12=>(0.0, 3.0)), (k13=>(0.0, 3.0)), (k14=>(0.0, 3.0)), (k21=>(0.0, 3.0)), (k31=>(0.0, 3.0)), (k41=>(0.0, 3.0)))
ic_constraints = Dict((x1=>(0.0, 3.0)), (x2=>(0.0, 3.0)), (x3=>(0.0, 3.0)), (x4=>(0.0, 3.0)))
 
time_interval = [-0.5, 0.5]
datasize = 21

data_sample = load("../data/julia/daisy_mamil4_7.jld2", "data")
