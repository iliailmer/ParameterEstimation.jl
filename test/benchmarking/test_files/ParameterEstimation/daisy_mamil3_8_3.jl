...
p_constraints = Dict((a12=>(0.0, 3.0)), (a13=>(0.0, 3.0)), (a21=>(0.0, 3.0)), (a31=>(0.0, 3.0)), (a01=>(0.0, 3.0)))
ic_constraints = Dict((x1=>(0.0, 3.0)), (x2=>(0.0, 3.0)), (x3=>(0.0, 3.0)))
 
time_interval = [-0.5, 0.5]
datasize = 21

data_sample = load("../data/julia/daisy_mamil3_8.jld2", "data")
