...
p_constraints = Dict((k5=>(0.0, 2.0)), (k6=>(0.0, 2.0)), (k7=>(0.0, 2.0)), (k8=>(0.0, 2.0)), (k9=>(0.0, 2.0)), (k10=>(0.0, 2.0)))
ic_constraints = Dict((x4=>(0.0, 2.0)), (x5=>(0.0, 2.0)), (x6=>(0.0, 2.0)))
 
time_interval = [-0.5, 0.5]
datasize = 21

data_sample = load("../data/julia/biohydrogenation_3.jld2", "data")
