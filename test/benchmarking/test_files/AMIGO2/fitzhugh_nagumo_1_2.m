...
% PATHS RELATED DATA
%======================
inputs.pathd.results_folder='fitzhugh_nagumo_1model'; % Folder to keep results
inputs.pathd.short_name='fitzhugh_nagumo_1';                 % To identify figures and reports
%======================
% MODEL RELATED DATA
%======================
clear
...
inputs.model.par = [0.617, 0.45, 0.813];         % Nominal value for the parameters
%==================================
...
% EXPERIMENT 1
inputs.exps.exp_y0{1}=[0.871, 0.407];        % Initial conditions
