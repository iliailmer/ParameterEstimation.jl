...
% PATHS RELATED DATA
%======================
inputs.pathd.results_folder='fitzhugh_nagumo_0model'; % Folder to keep results
inputs.pathd.short_name='fitzhugh_nagumo_0';                 % To identify figures and reports
%======================
% MODEL RELATED DATA
%======================
clear
...
% EXPERIMENT 1
inputs.exps.exp_y0{1}=[0.536, 0.439];        % Initial conditions
