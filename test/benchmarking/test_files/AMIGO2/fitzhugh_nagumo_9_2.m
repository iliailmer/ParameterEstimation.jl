...
% PATHS RELATED DATA
%======================
inputs.pathd.results_folder='fitzhugh_nagumo_9model'; % Folder to keep results
inputs.pathd.short_name='fitzhugh_nagumo_9';                 % To identify figures and reports
%======================
% MODEL RELATED DATA
%======================
clear
...
inputs.model.par = [0.637, 0.268, 0.203];         % Nominal value for the parameters
%==================================
...
% EXPERIMENT 1
inputs.exps.exp_y0{1}=[0.352, 0.391];        % Initial conditions
