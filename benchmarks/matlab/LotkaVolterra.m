...
inputs.model.eqns=char('dx1 = k1*x1-k2*x1*x2;', 'dx2 = k2*x1*x2-k3*x2;');                                 % Equations describing system dynamics.
...
inputs.model.par = [0.03 0.0005 0.05];         % Nominal value for the parameters
...
inputs.exps.exp_data{1}=[  100.0000
